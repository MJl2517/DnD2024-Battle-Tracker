...
export const playerCharacters = sqliteTable('player_characters', {
  ...
  alertInitiativeSwap: integer('alert_initiative_swap', { mode: 'boolean' }).notNull().default(false),
...
export const encounterCreatureGroups = sqliteTable('encounter_creature_groups', {
  ...
  initiativeDisadvantage: integer('initiative_disadvantage', { mode: 'boolean' }).notNull().default(false),
...
export const combatants = sqliteTable('combatants', {
  ...
  initiativeSwapUsed: integer('initiative_swap_used', { mode: 'boolean' }).notNull().default(false),
  initiativeMod: integer('initiative_mod').notNull(),
